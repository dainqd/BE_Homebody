        ...
        <ul class="d-flex align-items-center">
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.profile.show') }}">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('admin.app.setting') }}             ">
                    ...
                    <li>
                        <a class="dropdown-item d-flex align-items-center" href="{{ route('auth.web.logout') }}">
